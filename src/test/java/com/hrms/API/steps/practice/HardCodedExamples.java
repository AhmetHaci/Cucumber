...
public class HardCodedExamples {
    ...
    static String token="Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpYXQiOjE1OTUyMTcyNTcsImlzcyI6ImxvY2FsaG9zdCIsImV4cCI6MTU5NTI2MDQ1NywidXNlcklkIjoiODk3In0.QQHdQrRJOM7xDdCo5-pKTS-EdxMlfNM4gvSz7xI1pv0";
    ...
    public void sampleTestNotes() {
         ...
         */
        String token="Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpYXQiOjE1OTUyMTcyNTcsImlzcyI6ImxvY2FsaG9zdCIsImV4cCI6MTU5NTI2MDQ1NywidXNlcklkIjoiODk3In0.QQHdQrRJOM7xDdCo5-pKTS-EdxMlfNM4gvSz7xI1pv0";
...
//      }
    ...
    public void dPUTupdateCreateEmployee() {
        ...
        RequestSpecification updateCreateEmployeeRequest = given().header("Content-Type", "application/json").header("Authorization", token)
                .body(HardcodedConstants.updateCreateEmpBody());
